...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/public/frontend/css/reponsive.css')}}" type="text/css" />
                        ...
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item">
                                ...
                                <a href="" class="navbar-item__link hover-under-anima" >Hỗ trợ</a>
                                    ...
                                    {{-- <li class="navbar-item"><a class="navbar-item__link hover-under-anima">@user.hoTen</a></li>
                                    <li class="navbar-item"><a href=@Url.Action("Logout", "Account") class="navbar-item__link hover-under-anima">Thoát </a></li>
                  --}}
                ...
                <div class="grid">
                    <div class="header-main">
                        <div class="header-logo">
                            <a href="{{URL::to('/trangchu')}}" class="logo__link">
                                <img src="{{asset('/public/frontend/images/go.png')}}" alt="" style="width:160px;height:40px">
                            </a>
                        </div>
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                @foreach($groups as $group)
                                                    @if($cate->id_loai_sp == $group->id_loaisp)
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{ asset('public/frontend/images/'.$cate->anh_loaisp) }}" alt="">
                                                </div>
                                            </div>
                                        </div>
...
{{--                                  @   
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/raucunam.gif')}}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/thucphamdl.gif')}}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/banhkeocl.gif')}}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/bia.gif')}}" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/suacl.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/nuocngot.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/micl.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/trung.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/thucphamkho.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="listcate-item">
                                        ...
                                        <div class="img-nav">
                                            <div class="content">
                                                ...
                                                <div class="img-listcate">
                                                    <img src="{{asset('/public/frontend/images/homany.gif')}}">
                                                </div>
                                            </div>
                                        </div>
                                    </li> 
 --}}
            ...
            <div class="grid">
                <div class="grid__row">
                    ...
                    <div class="grid__column-2-5">
                        <h4>ABOUT GOFOOD</h4>
                        <ul class="list-ft__text">
                            <li class="ft__item"><a href="{{URL::to('/about')}}" class="ft-hover-a">Giới thiệu về GoFood</a></li>
                    ...
                    <div class="grid__column-2-5">
                        ...
                        <ul class="list-ft__text pay">
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend/images/visa.png')}}" style="width: 45px; height: 45px;" alt="Visa" title="Visa"></a></li>
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend/images/zalo.png')}}" style="width: 45px; height: 45px;" alt="Zalo Pay" title="Zalo Pay"></a></li>
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend/images/momo.jpg')}} " style="width: 45px; height: 45px;" alt="Momo" title="Momo"></a></li>
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend/images/vt.jpg')}}" style="width: 45px; height: 45px;object-fit: cover;" alt="Bank" title="Bank"></a></li>
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend/images/apppay.png')}}" style="width: 45px; height: 45px;object-fit: contain;" alt="Apple Pay" title="Apple Pay"></a></li>
                            <li class="ft__item"><a href="#"><img src="{{asset('/public/frontend//images/ggpay.png')}}" style="width: 45px; height: 45px;object-fit: contain;" alt="Google Pay" title="Google Pay"></a></li>
                    ...
                    <div class="grid__column-2-5">
                        <h4></h4>
                        <ul class="list-ft__text">
                            <li class="ft__item"><a href="{{URL::to('/trangchu')}}" class="logo__link"><img src="{{asset('/public/frontend/images/go.png')}}" style="height: 50px;"></a></li>
    ...
    <script src="{{asset('/public/frontend/js/modernizr-2.8.3.js')}}"></script>
