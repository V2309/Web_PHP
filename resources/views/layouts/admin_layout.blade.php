...
<head>
    ...
    <link href="{{asset('/public/backend/css/crud.css')}}" rel="stylesheet"  type="text/css"/>
   
    <link href="{{asset('/public/backend/css/all.min.css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('/public/backend/css/adminlte.min.css')}}" rel="stylesheet" type="text/css" />
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="" class="brand-link">
                <img src="{{asset('/public/backend/images/AdminLTELogo.png')}}"
                     alt="AdminLTE Logo"
    ...
    <script src="{{asset('/public/backend/js/modernizr-2.8.3.js')}}"></script>
