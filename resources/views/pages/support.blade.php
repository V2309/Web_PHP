    ...
    <div class="grid">
        <div class="contents-help">
            <div class="desc-help">
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help1.png')}}" alt="">
                </div>
                <p>
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help2.png')}}" alt="">
                </div>
                <p>
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help3.png')}}" alt="">
                </div>
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help4.png')}}" alt="">
                </div>
                <p>Sau khi hoàn tất chọn mua sản phẩm, Quý khách click chọn vào biểu tượng <strong>Giỏ hàng</strong> ở góc phải màn hình</p>
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help5.png')}}" alt="">
                </div>
                <p>Tiếp theo click "Xem Giỏ Hàng"</p>
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help6.png')}}" alt="">
                </div>
                <p>
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help7.png')}}" alt="">
                </div>
                <p>
                ...
                <div class="img-help">
                    <img src="{{asset('/public/frontend/images/help8.jpg')}}" alt="">
                </div>
